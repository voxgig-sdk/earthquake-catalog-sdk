...
// instead of `sdk.NewEarthquakeCatalogSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *EarthquakeCatalogSDK  { return NewEarthquakeCatalogSDK(nil) }
func Test() *EarthquakeCatalogSDK { return TestSDK(nil, nil) }
