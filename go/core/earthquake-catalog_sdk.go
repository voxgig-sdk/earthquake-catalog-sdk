...
type EarthquakeCatalogSDK struct {
	Mode     string
...
func (sdk *EarthquakeCatalogSDK) OptionsMap() map[string]any {
...
func (sdk *EarthquakeCatalogSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *EarthquakeCatalogSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *EarthquakeCatalogSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EarthquakeCatalogSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *EarthquakeCatalogSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *EarthquakeCatalogSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("EarthquakeCatalogSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *EarthquakeCatalogSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *EarthquakeCatalogSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("EarthquakeCatalogSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *EarthquakeCatalogSDK {
	...
	sdk := NewEarthquakeCatalogSDK(sdkopts)
	sdk.Mode = "test"
