...
const testSeed = `map[string]any{"entity": map[string]any{"earthquake_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "service_information": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
