...
## Install
```bash
go get github.com/voxgig-sdk/earthquake-catalog-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/earthquake-catalog-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/earthquake-catalog-sdk/go=../earthquake-catalog-sdk/go
```
...
func main() {
    ...
    earthquakeData, err := client.EarthquakeData(nil).Load(nil, nil)
    if err != nil {
        panic(err)
    }
...
| `EarthquakeData` | `(data map[string]any) EarthquakeCatalogEntity` | Create an EarthquakeData entity instance. |
