...
// EarthquakeCatalog SDK proxy feature
...
class EarthquakeCatalogProxyFeature extends EarthquakeCatalogBaseFeature
{
    ...
    public function init(EarthquakeCatalogContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EarthquakeCatalogContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
