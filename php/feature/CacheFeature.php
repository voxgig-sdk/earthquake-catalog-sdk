...
// EarthquakeCatalog SDK cache feature
...
class EarthquakeCatalogCacheFeature extends EarthquakeCatalogBaseFeature
{
    ...
    private function _through(EarthquakeCatalogContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
