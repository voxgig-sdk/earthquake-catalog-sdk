...
// EarthquakeCatalog SDK metrics feature
...
class EarthquakeCatalogMetricsFeature extends EarthquakeCatalogBaseFeature
{
    ...
    private function _record(EarthquakeCatalogContext $ctx, bool $ok): void
    {
