...
// EarthquakeCatalog SDK timeout feature
...
class EarthquakeCatalogTimeoutFeature extends EarthquakeCatalogBaseFeature
{
    ...
    private function _with_timeout(EarthquakeCatalogContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EarthquakeCatalogContext $_ctx, float $ms): void
    {
        $client = $this->client;
