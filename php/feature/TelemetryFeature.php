...
// EarthquakeCatalog SDK telemetry feature
...
class EarthquakeCatalogTelemetryFeature extends EarthquakeCatalogBaseFeature
{
    ...
    private function _close(EarthquakeCatalogContext $ctx, bool $ok): void
    {
