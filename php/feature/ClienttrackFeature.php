...
// EarthquakeCatalog SDK clienttrack feature
...
class EarthquakeCatalogClienttrackFeature extends EarthquakeCatalogBaseFeature
{
    ...
    public function PostConstruct(EarthquakeCatalogContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EarthquakeCatalog-SDK';
