...
// EarthquakeCatalog SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EarthquakeCatalogSDK::test)
...
{
    private const SDK_CLASS = 'EarthquakeCatalogSDK';
    ...
    private const SDK_BASE = 'earthquakecatalog_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../earthquakecatalog_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
