...
class EarthquakeDataEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set EARTHQUAKECATALOG_TEST_EARTHQUAKE_DATA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function earthquake_data_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("EARTHQUAKECATALOG_TEST_EARTHQUAKE_DATA_ENTID");
