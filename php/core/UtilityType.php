...
// EarthquakeCatalog SDK utility type

class EarthquakeCatalogUtility
{
    ...
    public static function copy(EarthquakeCatalogUtility $src): EarthquakeCatalogUtility
    {
        $u = new EarthquakeCatalogUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
