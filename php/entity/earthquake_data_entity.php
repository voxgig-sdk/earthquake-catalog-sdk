...
// EarthquakeCatalog SDK EarthquakeData entity
...
class EarthquakeDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EarthquakeDataEntity($this->_client, $opts);
    }

    /**
     * @param EarthquakeData|array $args EarthquakeData data (assoc-array) to store.
     */
    ...
    /**
     * @return EarthquakeData|array The current EarthquakeData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EarthquakeData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EarthquakeData fields).
     */
    ...
    /**
     * Load a single EarthquakeData.
     *
     * @param EarthquakeDataLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EarthquakeDataLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EarthquakeData|array The loaded EarthquakeData as an assoc-array at the
    ...
    /**
     * List EarthquakeData items matching the given filter.
     *
     * @param EarthquakeDataListMatch|array|null $reqmatch Match filter (any subset
     *   of EarthquakeData fields) as an assoc-array; EarthquakeDataListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EarthquakeData[]|array A list of EarthquakeData items as assoc-arrays at
