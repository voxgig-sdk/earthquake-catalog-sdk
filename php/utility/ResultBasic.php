...
// EarthquakeCatalog SDK utility: result_basic

class EarthquakeCatalogResultBasic
{
    public static function call(EarthquakeCatalogContext $ctx): ?EarthquakeCatalogResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof EarthquakeCatalogError) ? $result->err->msg : (string)$result->err;
