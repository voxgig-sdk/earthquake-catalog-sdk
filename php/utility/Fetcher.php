...
class EarthquakeCatalogFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EarthquakeCatalogSDK/1.0)';
    ...
    public static function call(EarthquakeCatalogContext $ctx, string $fullurl, array $fetchdef): array
    {
