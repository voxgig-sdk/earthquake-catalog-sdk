...
// EarthquakeCatalog SDK utility: graphql
//
...
class EarthquakeCatalogGraphql
{
    ...
    // equivalent.
    public static function body(EarthquakeCatalogContext $ctx): mixed
    {
    ...
    public static function errors(EarthquakeCatalogContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
