...
(0, node_test_1.describe)('EarthquakeDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-earthquake_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-earthquake_data', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-earthquake_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-earthquake_data', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['EARTHQUAKE_CATALOG_TEST_EARTHQUAKE_DATA_ENTID'];
...
//# sourceMappingURL=EarthquakeDataDirect.test.js.map