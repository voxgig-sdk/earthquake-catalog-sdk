...
(0, node_test_1.describe)('ServiceInformationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EarthquakeCatalogSDK({
    ...
    (0, node_test_1.test)('direct-load-service_information', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-service_information', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-service_information', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-service_information', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.EARTHQUAKE_CATALOG_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.EarthquakeCatalogSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['EARTHQUAKE_CATALOG_TEST_SERVICE_INFORMATION_ENTID'];
    ...
    const client = new __1.EarthquakeCatalogSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ServiceInformationDirect.test.js.map