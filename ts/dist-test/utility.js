...
function envOverride(m) {
    if ('TRUE' === process.env.EARTHQUAKE_CATALOG_TEST_LIVE ||
        'TRUE' === process.env.EARTHQUAKE_CATALOG_TEST_OVERRIDE) {
    ...
    m.EARTHQUAKE_CATALOG_TEST_EXPLAIN = process.env.EARTHQUAKE_CATALOG_TEST_EXPLAIN || m.EARTHQUAKE_CATALOG_TEST_EXPLAIN;
    return m;
}
