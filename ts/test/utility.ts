...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.EARTHQUAKECATALOG_TEST_LIVE ||
    'TRUE' === process.env.EARTHQUAKECATALOG_TEST_OVERRIDE
  ) {
  ...
  m.EARTHQUAKECATALOG_TEST_EXPLAIN = process.env.EARTHQUAKECATALOG_TEST_EXPLAIN || m.EARTHQUAKECATALOG_TEST_EXPLAIN
