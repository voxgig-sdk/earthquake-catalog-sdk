// Command EarthquakeCatalog-mcp is an MCP server exposing the EarthquakeCatalog
// SDK as MCP tools.
//
// Two tools are registered:
//
//	EarthquakeCatalog_list  — list records of an entity
//	EarthquakeCatalog_load  — load a single record of an entity
//
