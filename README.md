...
This API allows users to perform custom searches for earthquake information based on various parameters, such as location, time, and magnitude.

Learn more about Earthquake Catalog API at [earthquake.usgs.gov](https://earthquake.usgs.gov).
...
| Python | `voxgig-sdk-earthquake-catalog-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/earthquake-catalog-sdk/tags) |
| PHP | `voxgig-sdk/earthquake-catalog-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/earthquake-catalog-sdk/tags) |
| Golang | `github.com/voxgig-sdk/earthquake-catalog-sdk/go` | `go get github.com/voxgig-sdk/earthquake-catalog-sdk/go@latest` |
| Ruby | `voxgig-sdk-earthquake-catalog-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/earthquake-catalog-sdk/tags) |
| Lua | `voxgig-sdk-earthquake-catalog-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/earthquake-catalog-sdk/tags) |
...
$earthquakedatas = $client->EarthquakeData()->list();
print_r(array_map(fn($item) => $item->data_get(), $earthquakedatas));
