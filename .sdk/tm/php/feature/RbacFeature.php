...
// EarthquakeCatalog SDK rbac feature
...
class EarthquakeCatalogRbacFeature extends EarthquakeCatalogBaseFeature
{
    ...
    private function _required(EarthquakeCatalogContext $ctx): ?string
    {
    ...
    private function _reject(EarthquakeCatalogContext $ctx, string $required): void
    {
    ...
    private function _track(EarthquakeCatalogContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
