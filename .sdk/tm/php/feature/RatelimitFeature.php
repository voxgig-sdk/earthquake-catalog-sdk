...
// EarthquakeCatalog SDK ratelimit feature
...
class EarthquakeCatalogRatelimitFeature extends EarthquakeCatalogBaseFeature
{
    ...
    private function _acquire(EarthquakeCatalogContext $ctx): void
    {
    ...
    private function _track(EarthquakeCatalogContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
