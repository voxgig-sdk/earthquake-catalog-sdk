...
// EarthquakeCatalog SDK netsim feature
...
class EarthquakeCatalogNetsimFeature extends EarthquakeCatalogBaseFeature
{
    ...
    private function _simulate(EarthquakeCatalogContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EarthquakeCatalogContext $ctx, array $applied): void
    {
        $client = $this->client;
