...
// EarthquakeCatalog SDK streaming feature
...
class EarthquakeCatalogStreamingFeature extends EarthquakeCatalogBaseFeature
{
    ...
    private function _iterate(EarthquakeCatalogResult $result): \Generator
    {
    ...
    private function _streamable(EarthquakeCatalogContext $ctx): bool
    {
