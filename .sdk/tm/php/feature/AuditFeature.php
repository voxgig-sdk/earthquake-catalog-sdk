...
// EarthquakeCatalog SDK audit feature
...
class EarthquakeCatalogAuditFeature extends EarthquakeCatalogBaseFeature
{
    ...
    private function _emit(EarthquakeCatalogContext $ctx, string $outcome): void
    {
