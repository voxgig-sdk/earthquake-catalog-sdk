...
// EarthquakeCatalog SDK utility: make_options

class EarthquakeCatalogMakeOptions
{
    ...
    public static function call(EarthquakeCatalogContext $ctx): array
    {
        ...
        //
        // `EarthquakeCatalogSchema::optspec()` is built from the model:
        ...
        $optspec = EarthquakeCatalogSchema::optspec();
