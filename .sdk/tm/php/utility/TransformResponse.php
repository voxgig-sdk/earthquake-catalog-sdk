...
// EarthquakeCatalog SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class EarthquakeCatalogTransformResponse
{
    public static function call(EarthquakeCatalogContext $ctx): mixed
    {
        ...
        $transform = EarthquakeCatalogHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
