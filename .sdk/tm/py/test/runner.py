...
class EarthquakeCatalogTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = EarthquakeCatalogTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = EarthquakeCatalogTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = EarthquakeCatalogTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
