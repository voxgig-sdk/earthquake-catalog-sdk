...
|---|---|---|
| `ts/` | @voxgig-sdk/earthquake-catalog-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/earthquake-catalog-sdk \
      --repository voxgig-sdk/earthquake-catalog-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/earthquake-catalog-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/earthquake-catalog-sdk --id=<id>` removes one.
