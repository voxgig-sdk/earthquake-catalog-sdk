...
#      offline in seeded test mode (EarthquakeCatalogSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "EarthquakeCatalog_sdk.rb")
  SDK_CLASS = "EarthquakeCatalogSDK"
  ...
  SDK_BASE = "EarthquakeCatalog_sdk"
