...
local ServiceInformationEntity = {}
ServiceInformationEntity.__index = ServiceInformationEntity


function ServiceInformationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ServiceInformationEntity)
  self._name = "service_information"
  self._client = client
...
function ServiceInformationEntity:get_name()
  return self._name
end


function ServiceInformationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ServiceInformationEntity.new(self._client, opts)
end
...
function ServiceInformationEntity:mark_deleted()
  self._deleted = true
end


function ServiceInformationEntity:deleted()
  return true == self._deleted
end


function ServiceInformationEntity:data_set(args)
  if args ~= nil then
...
function ServiceInformationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ServiceInformationEntity:match_set(args)
  if args ~= nil then
...
function ServiceInformationEntity:match_get()
...
function ServiceInformationEntity:stream(action, args, callopts)
...
function ServiceInformationEntity:_run_op(ctx, post_done)
  local utility = self._utility
