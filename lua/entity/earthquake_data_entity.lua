...
local EarthquakeDataEntity = {}
EarthquakeDataEntity.__index = EarthquakeDataEntity


function EarthquakeDataEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EarthquakeDataEntity)
  self._name = "earthquake_data"
  self._client = client
...
function EarthquakeDataEntity:get_name()
  return self._name
end


function EarthquakeDataEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EarthquakeDataEntity.new(self._client, opts)
end
...
function EarthquakeDataEntity:mark_deleted()
  self._deleted = true
end


function EarthquakeDataEntity:deleted()
  return true == self._deleted
end


function EarthquakeDataEntity:data_set(args)
  if args ~= nil then
...
function EarthquakeDataEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EarthquakeDataEntity:match_set(args)
  if args ~= nil then
...
function EarthquakeDataEntity:match_get()
...
function EarthquakeDataEntity:stream(action, args, callopts)
...
function EarthquakeDataEntity:_run_op(ctx, post_done)
  local utility = self._utility
