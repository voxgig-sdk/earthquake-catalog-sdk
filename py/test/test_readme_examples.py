# EarthquakeCatalog SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EarthquakeCatalogSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EarthquakeCatalogSDK(...) and EarthquakeCatalogSDK.test(...) become
#      EarthquakeCatalogSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "earthquakecatalog_sdk"
_SDK_CLASS = "EarthquakeCatalogSDK"
...
_ENTITIES = {
    "EarthquakeData": "earthquake_data",
