...
from earthquakecatalog_sdk.utility import register

# Load features
from earthquakecatalog_sdk.feature.base_feature import EarthquakeCatalogBaseFeature
from earthquakecatalog_sdk.features import _has_feature, _make_feature
...
class EarthquakeCatalogSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = EarthquakeCatalogUtility()
        self._utility = utility

        from earthquakecatalog_sdk.config import shared_config
    ...
    def get_utility(self):
        return EarthquakeCatalogUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EarthquakeCatalogSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def EarthquakeData(self, data=None) -> "EarthquakeDataEntity":
        ...
        from earthquakecatalog_sdk.entity.earthquake_data_entity import EarthquakeDataEntity
    ...
    def ServiceInformation(self, data=None) -> "ServiceInformationEntity":
        ...
        from earthquakecatalog_sdk.entity.service_information_entity import ServiceInformationEntity
