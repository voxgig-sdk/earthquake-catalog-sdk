// Command EarthquakeCatalog-cli is a CLI + REPL for the EarthquakeCatalog SDK,
...
const prompt = "earthquake-catalog"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "earthquake_data service_information"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      EARTHQUAKE_CATALOG_APIKEY (api key), EARTHQUAKE_CATALOG_BASE (base url override)")
