...
AQL-driven CLI and REPL for the EarthquakeCatalog SDK. Positional arguments are
...
```sh
go build -o earthquake-catalog-cli ./...
```
...
./earthquake-catalog-cli load 1 earthquake_data
./earthquake-catalog-cli load '{id:1}' earthquake_data
