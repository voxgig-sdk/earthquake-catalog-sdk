...
func registerSDKWords(r *eng.Registry, client *sdk.EarthquakeCatalogSDK) {
...
func runOp(client *sdk.EarthquakeCatalogSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
